...
### 参考 https://gist.github.com/ricardo-rossi/8265589463915837429d
...
### Install Java 8 由于网络原因，所以选用下面的 Install OpenJDK 。参考 https://www.digitalocean.com/community/tutorials/how-to-install-elasticsearch-on-an-ubuntu-vps
cd ~
